...
//     String selectedIconKey = category?['icon'] ?? iconsList.keys.first;

//     showDialog(
//       context: context,
//       builder: (_) => AlertDialog(
//         title: Text(category == null ? (parent == null ? "Thêm danh mục cha" : "Thêm danh mục con") : "Sửa danh mục"),
//         content: Column(
//           mainAxisSize: MainAxisSize.min,
//           children: [
//             TextField(
...
//                       ))
//                   .toList(),
//               onChanged: (val) => setState(() => selectedIconKey = val!),
//             ),
//           ],
//         ),
//         actions: [
...
//                       mainAxisSize: MainAxisSize.min,
//                       children: [
//                         IconButton(icon: const Icon(Icons.edit, color: Colors.blue), onPressed: () => _addOrEditCategory(category: child)),
//                         IconButton(icon: const Icon(Icons.delete, color: Colors.red), onPressed: () => _deleteCategory(child)),
//                       ],
//                     ),
//                     onTap: () => Navigator.pop(context, child), // Trả về cả Map cho TransactionScreen
//                   ),
//                 ),
//                 TextButton.icon(
...
//                   mainAxisAlignment: MainAxisAlignment.end,
//                   children: [
//                     IconButton(icon: const Icon(Icons.edit, color: Colors.blue), onPressed: () => _addOrEditCategory(category: parent)),
//                     IconButton(icon: const Icon(Icons.delete, color: Colors.red), onPressed: () => _deleteCategory(parent)),
//                   ],
//                 ),
//               ],
          ...
          TextButton(
            onPressed: () async {
              ...
              if (category == null) {
                ...
                // Chỉ sửa danh mục của người dùng
                success = await _service.editCategory(category['id'], {
                  "ten_danh_muc": nameCtrl.text,
                  "icon": selectedIconKey,
                });
