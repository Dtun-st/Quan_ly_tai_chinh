...
import 'package:frontend/screen/bottom_nav.dart'; // nhớ file bottom_nav của bạn
...
class _TransactionScreenState extends State<TransactionScreen> {
  ...
  void _saveTransaction() {
    ...
    // Mock hiện thị result — thay bằng API call POST /transactions
    final data = {
