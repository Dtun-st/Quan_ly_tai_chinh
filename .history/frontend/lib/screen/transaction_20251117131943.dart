...
class _TransactionScreenState extends State<TransactionScreen> {
        ...
        child: Row(
          ...
          children: [
            Text(
              ...
              style: TextStyle(color: selectedChiCon == null ? Colors.grey : Colors.black),
            ),
  ...
  Widget _buildTransactionList() {
    ...
    List<Map<String, String>> transactions = [
      {"type": "Chi", "name": "Cà phê", "amount": "50,000 VND"},
      {"type": "Thu", "name": "Lương", "amount": "5,000,000 VND"},
      {"type": "Chi", "name": "Taxi", "amount": "120,000 VND"},
    ];
    ...
    return Column(
      children: transactions
          .map((tx) => Card(
                margin: const EdgeInsets.symmetric(vertical: 4),
                child: ListTile(
                  leading: Icon(tx['type'] == "Chi" ? Icons.remove : Icons.add,
                      color: tx['type'] == "Chi" ? Colors.red : Colors.green),
                  title: Text("${tx['amount']} - ${tx['name']}"),
