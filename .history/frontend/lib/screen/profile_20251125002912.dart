        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildInfoRow(Icons.phone_android_rounded, "Số điện thoại",
                  userData!['phone']),
              const Divider(height: 1),
              _buildInfoRow(
                  Icons.calendar_today_rounded, "Ngày tạo", userData!['ngay_tao']),
            ],
          ),
        ),
      ),
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildActionTile(Icons.notifications_rounded,
              "Cài đặt Thông báo", Colors.blue),
          _buildActionTile(
              Icons.lock_rounded, "Bảo mật & Quyền riêng tư", Colors.purple),
