...
class BudgetCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    double percentUsed = (spent / budget!).clamp(0, 1);
    Color progressColor;
    String warningMessage = "";

    if (percentUsed >= 1.0) {
      progressColor = Colors.red;
      warningMessage = "Bạn đã vượt ngân sách!";
    } else if (percentUsed >= 0.8) {
      progressColor = Colors.orange;
      warningMessage = "Sắp hết ngân sách!";
    } else {
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Text("Đã chi: ${spent.toStringAsFixed(0)} VND"),
                Text("Ngân sách: ${budget!.toStringAsFixed(0)} VND"),
              ],
            ),
