...
class _TransactionScreenState extends State<TransactionScreen> {
  String type = 'Chi'; // mặc định Chi
  DateTime selectedDate = DateTime.now();

  // Dữ liệu cứng
  final chiCategories = ['Ăn uống', 'Di chuyển', 'Hóa đơn', 'Mua sắm'];
  final thuCategories = ['Lương', 'Quà', 'Tiền hoàn trả'];

  String selectedChiCategory = 'Ăn uống';
  String selectedThuCategory = 'Lương';

  final _amountCtrl = TextEditingController(text: "0");
  final _descCtrl = TextEditingController(text: "Mô tả giao dịch");
    ...
    if (type == 'Chi') {
      return DropdownButtonFormField<String>(
        ...
        items: chiCategories
            ...
            .toList(),
        onChanged: (v) {},
        decoration: const InputDecoration(labelText: 'Chọn hạng mục Chi'),
      );
    } else {
      return DropdownButtonFormField<String>(
        ...
        items: thuCategories
            ...
            .toList(),
        onChanged: (v) {},
        decoration: const InputDecoration(labelText: 'Chọn hạng mục Thu'),
      );
    }
  }
          ...
          children: [
            ...
            Card(
              child: ListTile(
                ...
                title: const Text('50,000 VND - Ăn sáng'),
                subtitle: Text('Ngày: ${DateTime.now().day}/${DateTime.now().month}/${DateTime.now().year}'),
                trailing: Row(
                  mainAxisSize: MainAxisSize.min,
                  children: const [
            ...
            Card(
              child: ListTile(
                ...
                title: const Text('1,000,000 VND - Lương tháng 10'),
                subtitle: Text('Ngày: ${DateTime.now().day}/${DateTime.now().month}/${DateTime.now().year}'),
                trailing: Row(
                  mainAxisSize: MainAxisSize.min,
                  children: const [
