...
class _TransactionScreenState extends State<TransactionScreen> {
  ...
  Widget _buildForm() {
    return Container(
      padding: const EdgeInsets.all(16),
      decoration:
          BoxDecoration(color: neutralColor, borderRadius: BorderRadius.circular(16)),
      child: Column(
        children: [
          _buildAmountField(),
          const SizedBox(height: 16),
  ...
  Widget _buildTransactionList() {
    ...
    return Column(
      children: transactions.map((tx) {
        final amountText = "${tx['loai_gd'] == "Chi" ? "-" : "+"}${tx['so_tien']} VND";
            ...
            ListTile(
              ...
              onTap: () {
                ...
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (_) => const ChiCategoryScreen()));
              },
            ),
            Flexible(
              child: ListView(
            ...
            ListTile(
              ...
              onTap: () {
                ...
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (_) => const ThuCategoryScreen()));
              },
            ),
            Flexible(
              child: ListView(
