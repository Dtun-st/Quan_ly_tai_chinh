...
// MÀU SẮC MỚI
// ===================
const Color primaryColor = Color(0xFFFF6D00); // Cam đậm
...
class _HomePageState extends State<HomePage> {
  ...
  Widget _buildUserHeader() {
    return GestureDetector(
      ...
      child: Row(
        children: [
          CircleAvatar(radius: 20, backgroundColor: Colors.white, child: Icon(Icons.person, color: primaryColor, size: 30)),
          const SizedBox(width: 12),
  ...
  Widget _buildThongKeTaiChinh() {
    return Row(
      ...
      children: [
        ...
        _financialCard("Cân đối", canDoi, canDoi >= 0 ? primaryColor : Colors.red),
      ],
    );
  }
    ...
    return Card(
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) {
          ...
          return ListTile(
            leading: CircleAvatar(backgroundColor: primaryColor.withOpacity(0.1), child: Icon(tk['icon'] as IconData?, color: primaryColor)),
  ...
  Widget _buildThongBaoList() {
    return Column(
      children: thongBao.map((tb) {
        ...
        final color = isCanhBao ? Colors.red.shade600 : primaryColor;
