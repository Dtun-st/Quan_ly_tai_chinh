...
class _BankScreenState extends State<BankScreen> {
  List<Map<String, String>> banks = [
    {
      "name": "Vietcombank",
      "account": "0123456789",
      "logo": "https://upload.wikimedia.org/wikipedia/commons/9/9e/Logo_Vietcombank.png"
    },
    {
      "name": "Techcombank",
      "account": "9876543210",
      "logo": "https://upload.wikimedia.org/wikipedia/commons/3/38/Techcombank_logo.png"
    },
    {
      "name": "MB Bank",
      "account": "1122334455",
      "logo": "https://upload.wikimedia.org/wikipedia/commons/0/07/Military_Bank_logo.png"
    },
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          // TODO: Chuyển sang màn thêm ngân hàng
        },
        backgroundColor: Colors.deepOrange,
