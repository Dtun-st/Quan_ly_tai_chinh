...
class _BankScreenState extends State<BankScreen> {
  ...
  // }
  Future<void> _loadAccounts() async {
    await _service.loadAccounts(); // load từ server và lưu vào _accounts
    setState(() {
      accounts = _service.accounts; // lấy từ state cục bộ
      ...
      child: Row(
        children: [
          CircleAvatar(
            ...
            child: Icon(
              acc["icon"] ?? Icons.account_balance_wallet,
          ...
          Text(
            isHidden ? "*****" : "${balance.toStringAsFixed(0)} đ",
            style: TextStyle(
              fontSize: 16,
              fontWeight: FontWeight.bold,
          ...
          IconButton(
            ...
            onPressed: () => _openAccountForm(account: acc),
          ),
          IconButton(
