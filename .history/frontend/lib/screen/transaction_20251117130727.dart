  ...
  Widget _buildChiDanhMucDropdown() {
    return Column(
      children: chiDanhMuc.map((cat) {
        bool isSelected = selectedChiDanhMuc == cat['name'];
        return ExpansionTile(
          ...
          children: cat['children']
              .map<Widget>((c) => ListTile(
                    ...
                    trailing: selectedChiCon == c ? const Icon(Icons.check, color: Colors.orange) : null,
                  ))
              .toList(),
        );
      }).toList(),
        ...
        DropdownButtonFormField<String>(
          ...
          items: thuLoai
              .map((e) => DropdownMenuItem<String>(
                    ...
                    child: Row(children: [Icon(e['icon']), const SizedBox(width: 8), Text(e['name'])]),
                  ))
              .toList(),
