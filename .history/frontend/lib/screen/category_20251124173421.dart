...
class _CategoryScreenUIState extends State<CategoryScreenUI> {
  ...
  void _addCategory({Map<String, dynamic>? parent}) {
    ...
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        content: TextField(controller: controller, decoration: const InputDecoration(labelText: "Tên danh mục")),
        actions: [
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text("Danh mục"), backgroundColor: Colors.orange),
            ...
            child: ExpansionTile(
              ...
              children: [
                ...children.map((child) => ListTile(
                      ...
                      onTap: () => Navigator.pop(context, child), // trả về TransactionScreen
                    )),
                TextButton.icon(
