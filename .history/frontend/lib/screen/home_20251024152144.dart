...
//                     Text("${total.toStringAsFixed(0)} VND", style: const TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),
//                   ],
//                 ),
//               ),
//             ),
...
class _HomePageState extends State<HomePage> {
  int _selectedIndex = 0; // để theo dõi tab đang chọn
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 80), // khoảng trống cho bottom navigation
          ],
        ),
      ),
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        onTap: (index) {
          setState(() {
            ...
            // TODO: có thể thêm logic chuyển trang khi chọn tab
