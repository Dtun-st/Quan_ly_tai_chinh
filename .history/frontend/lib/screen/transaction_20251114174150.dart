...
class _TransactionScreenState extends State<TransactionScreen> {
  ...
  int? editingTransactionId; // để biết đang sửa giao dịch nào
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      child: Text(
                        editingTransactionId != null ? 'Cập nhật giao dịch' : 'Lưu giao dịch',
                  ...
                  return Card(
                    ...
                    child: ListTile(
                      ...
                      trailing: Row(
                        ...
                        children: [
                          Text(categoryName, style: TextStyle(color: color, fontWeight: FontWeight.bold)),
                          const SizedBox(width: 8),
                          IconButton(
