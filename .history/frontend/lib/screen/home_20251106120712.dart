...
// import 'package:financial_app/screen/bank.dart'; // chỉnh lại path nếu khác
...
class _HomePageState extends State<HomePage> {
  ...
  // ✅ Sửa lại để chuyển sang trang Bank khi index == 1
  void _onBottomNavTapped(int index) {
    setState(() {
      _selectedIndex = index;
    });
    ...
    switch (index) {
      ...
      case 1:
        ...
        break;
      case 2:
        // TODO: chuyển sang trang ghi chép
        break;
      case 3:
        // TODO: chuyển sang trang báo cáo
        break;
    }
  }
