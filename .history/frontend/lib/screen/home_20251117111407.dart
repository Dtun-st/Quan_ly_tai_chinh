...
class _HomePageState extends State<HomePage> {
  ...
  double get totalIncome => giaoDichGoc
      .where((g) => g["loai"] == "Thu")
      .fold(0, (sum, g) => sum + g["so_tien"]);

  double get totalExpense => giaoDichGoc
      .where((g) => g["loai"] == "Chi")
      .fold(0, (sum, g) => sum + g["so_tien"]);
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 20),
            _buildTitle("Recent Transactions"),
            const SizedBox(height: 8),
            _buildGiaoDichList(),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _financialRow("Total Income", totalIncome, Colors.green),
            const SizedBox(height: 4),

            _financialRow("Total Expense", totalExpense, Colors.red),
            const SizedBox(height: 4),

            _financialRow("Net Balance", netBalance,
  ...
  Widget _buildActionButtons() {
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: [
        _actionCard(Icons.add_circle, "Income", Colors.green),
        _actionCard(Icons.remove_circle, "Expense", Colors.red),
      ],
    );
  }
