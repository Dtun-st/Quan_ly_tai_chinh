...
const Color neutralColor = Color(0xFFF5F5F5); // Xám nhạt cho nền
...
class _TransactionScreenState extends State<TransactionScreen> {
  ...
  final List<Map<String, dynamic>> accounts = [
    {"id": 1, "name": "Tiền mặt", "icon": Icons.money_rounded}, // Thay đổi icon
    {"id": 2, "name": "Thẻ tín dụng", "icon": Icons.credit_card_rounded}, // Thay đổi icon
    {"id": 3, "name": "Ngân hàng", "icon": Icons.account_balance_rounded}, // Thay đổi icon
  ];
  int? selectedAccountId;
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              padding: const EdgeInsets.all(16),
              decoration: BoxDecoration(
                color: neutralColor, // Nền xám nhạt cho khu vực form
                borderRadius: BorderRadius.circular(16),
              ),
              child: isChi ? _buildChiForm() : _buildThuForm(),
            ),
            const SizedBox(height: 30),
  ...
  // =============================
  // UI COMPONENTS (CHỈNH SỬA GIAO DIỆN)
  // =============================
  ...
  Widget _buildChiForm() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        _buildAmountField(Colors.red.shade600), // Chi màu đỏ
        const SizedBox(height: 16),
        ...
        _buildDescField(),
        const SizedBox(height: 20),
        _buildSaveButton(Colors.red.shade600),
      ],
    );
  }
  ...
  Widget _buildThuForm() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        _buildAmountField(Colors.green.shade600), // Thu màu xanh
        const SizedBox(height: 16),
        _buildAccountDropdown(),
        const SizedBox(height: 16),
        _buildThuLoaiField(),
        ...
        _buildDescField(),
        const SizedBox(height: 20),
        _buildSaveButton(Colors.green.shade600),
      ],
    );
  }
  ...
  Widget _buildSaveButton(Color color) {
    return SizedBox(
      ...
      child: ElevatedButton.icon(
        ...
        label: const Text("LƯU GIAO DỊCH", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.white)),
  ...
  Widget _buildTransactionList() {
    // Mẫu cứng (Giữ nguyên dữ liệu mẫu)
  ...
  // =============================
  // BOTTOM SHEET & FUNCTIONS (GIỮ NGUYÊN LOGIC)
  // =============================
  void _showChiMenu() {
        ...
        return Theme(
          data: ThemeData(
            colorScheme: ColorScheme.light(
              primary: primaryColor, // Màu chủ đạo cho DatePicker
