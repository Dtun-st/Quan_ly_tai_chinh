...
class _TransactionScreenState extends State<TransactionScreen> {
  ...
  void _editTransaction(Map<String, dynamic> tx) {
    setState(() {
      ...
      selectedAccountId = tx['taiKhoanId']; // sửa theo backend
      selectedCategoryId = tx['hanMucId']; // sửa theo backend
      type = tx['loaiGd']; // sửa theo backend
      _amountCtrl.text = tx['soTien'].toString(); // sửa theo backend
      _descCtrl.text = tx['moTa'] ?? '';
      selectedDate = DateTime.parse(tx['ngayGiaoDich']); // sửa theo backend
    });
  }
