...
class _TransactionScreenState extends State<TransactionScreen> {
  ...
  final List<Map<String, dynamic>> chiDanhMuc = [
    {
      ...
      "icon": Icons.fastfood,
      "children": [
        {"id": 11, "name": "Nhà hàng", "icon": Icons.restaurant},
        {"id": 12, "name": "Café", "icon": Icons.local_cafe},
      ]
    },
    {
      "id": 2,
      ...
      "children": [
        {"id": 21, "name": "Xe máy", "icon": Icons.motorcycle},
        {"id": 22, "name": "Taxi", "icon": Icons.local_taxi},
      ]
    },
  ];
  String? selectedChiDanhMuc;
  ...
  final List<Map<String, dynamic>> thuLoai = [
    {"id": 1, "name": "Lương", "icon": Icons.attach_money},
    {"id": 2, "name": "Thưởng", "icon": Icons.card_giftcard},
  ];
  String? selectedThuLoai;
  ...
  void saveTransaction() {
    String categoryName = isChi ? (selectedChiCon ?? "") : (selectedThuLoai ?? "");

    if ((isChi && selectedChiCon == null) || (!isChi && selectedThuLoai == null)) {
      ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text("Vui lòng chọn danh mục hoặc loại thu")));
      return;
    }
    ...
    setState(() {
      transactions.insert(0, {
        ...
        "ngay_giao_dich": selectedDate,
        "anh_hoa_don": kIsWeb ? null : selectedImageFile?.path,
      });
      amountCtrl.clear();
      descCtrl.clear();
      selectedImageFile = null;
