...
//                       showTitles: true,
//                       interval: (data.values.isNotEmpty) ? data.values.reduce((a,b)=>a>b?a:b)/5 : 100,
...
//                     x: index,
//                     barRods: [BarChartRodData(toY: data[key]!, color: colors[key] ?? Colors.grey, width: 20)],
//                   );
//                 }),
//               ),
//             ),
            ...
            child: BarChart(
              BarChartData(
                ...
                barGroups: List.generate(data.length, (index) {
                  ...
                  return BarChartGroupData(
                    x: index,
                    barRods: [BarChartRodData(toY: data[key]!, color: getColorForCategory(key), width: 20)],
                  );
                }),
              ),
            ),
