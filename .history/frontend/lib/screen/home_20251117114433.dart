...
class _HomePageState extends State<HomePage> {
          ...
          children: [
            Column(
              ...
              children: [
                ...
                const SizedBox(height: 8),
                Text("${tongSoDu.toStringAsFixed(0)} VND",
  ...
  Widget _buildThongKeTaiChinh() {
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: [
        _financialCard("Tổng Thu", tongThu, Colors.green),
        _financialCard("Tổng Chi", tongChi, Colors.red),
        _financialCard("Cân đối", tongSoDu, tongSoDu >= 0 ? Colors.blue : Colors.red),
      ],
    );
  }
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              const SizedBox(height: 8),
              Text("${amount.toStringAsFixed(0)} VND",
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            const Text("Tài khoản hiện có", style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
            const SizedBox(height: 12),
            ...taiKhoan.map((tk) => Padding(
                  padding: const EdgeInsets.symmetric(vertical: 6),
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text(tk["ten"], style: const TextStyle(fontSize: 14)),
                      Text("${tk["so_du"]} VND", style: const TextStyle(fontSize: 14, fontWeight: FontWeight.bold)),
                    ],
                  ),
                ))
          ],
