...
class BankService {
  ...
  Future<List<Map<String, dynamic>>> getAccounts(int userId) async {
    final url = Uri.parse('${ApiConfig.baseUrl}/bank/$userId'); // sửa /api/accounts -> /bank
  ...
  Future<bool> addAccount(Map<String, dynamic> account) async {
    final url = Uri.parse('${ApiConfig.baseUrl}/bank'); // sửa /api/accounts -> /bank
  ...
  Future<bool> editAccount(int id, Map<String, dynamic> account) async {
    final url = Uri.parse('${ApiConfig.baseUrl}/bank/$id'); // sửa /api/accounts -> /bank
