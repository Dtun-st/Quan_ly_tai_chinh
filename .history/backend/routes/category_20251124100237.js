...
/**
 * Hàm chèn dữ liệu mẫu cho user mới
 */
async function insertDefaultCategories(userId) {
  const defaultCategories = [
    { name: 'Ăn uống', type: 'Chi', icon: '58478', parentName: null },
    { name: 'Mua sắm', type: 'Chi', icon: '58716', parentName: null },
    { name: 'Nhà cửa', type: 'Chi', icon: '57546', parentName: null },
    { name: 'Xe cộ', type: 'Chi', icon: '59185', parentName: null },

    // Danh mục con
    { name: 'Cà phê', type: 'Chi', icon: '61527', parentName: 'Ăn uống' },
    { name: 'Ăn sáng', type: 'Chi', icon: '58478', parentName: 'Ăn uống' },
    { name: 'Quần áo', type: 'Chi', icon: '58963', parentName: 'Mua sắm' },
    { name: 'Giày dép', type: 'Chi', icon: '59623', parentName: 'Mua sắm' },
  ];
  ...
  for (const cat of defaultCategories) {
    let parentId = null;
    if (cat.parentName) parentId = parentMap[cat.parentName];
...
// Xuất ra hàm insertDefaultCategories để dùng trong register.js
module.exports = { router, insertDefaultCategories };
