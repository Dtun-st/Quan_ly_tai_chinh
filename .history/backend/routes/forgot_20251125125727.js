...
const pool = require('../db'); // pool MySQL đã cấu hình
...
const transporter = nodemailer.createTransport({
  ...
  auth: {
    ...
    pass: 'eeri qkpk dpmh oswm', // Gmail App Password
  },
});
...
router.post('/', async (req, res) => {
  ...
  try {
    ...
    await pool.execute('UPDATE nguoi_dung SET reset_code=?, reset_code_expire=? WHERE email=?', [code, expire, email]);
