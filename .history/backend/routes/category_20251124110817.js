...
// module.exports.insertDefaultCategories = insertDefaultCategories; // export thêm hàmconst express = require('express');
const router = express.Router();
const pool = require('../db');
...
// Thêm danh mục con (lấy type theo parent nếu không gửi)
router.post('/:parentId/children', async (req, res) => {
  const { parentId } = req.params;
